...
//		}
		...
		System.out.println("커피 가격은" + price + "");
		...
		//       	ADEFSGESGS
		//          ...
		int symbool_size = 'Z' -'A' +1; // 26 -> 대문자 범위 사이즈를 알기 위해 (값이 0부터 시작하기 때문에 +1)
		for (int i =0; i <50; i++) { //랜덤값 50개
			char ch3 =(char)(Math.random()*symbool_size +'A');
