...
public class PersonsVO {
 // VO클래스 or DTO 클래스 -> 목적 자체가 다름
 // VO클래스 (Value Object Class) -객체에 값을 저장하는 형태. DB나 데이터를 저장하는 용도
 // 							 변수들의 모음 역할(저장의 목적)
 //DTO클래스 (Data Transfer Object Class) -데이터 전송 처리를 위한 값을 저장하는 형태의 객체 (전송을 목적)
...
public String toString() {
	...
	return "PersonsVO [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", age=" + age + ", city="
			+ city + "]";
}
